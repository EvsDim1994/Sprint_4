class TestBooksCollector():
    ...
    def test_add_new_book_with_correct_lenght(self, collector_book):
    ...
    def test_add_new_book_with_lenght_more_than_41_symbols(self, collector_book):
        collector_book.add_new_book('Очень длинное название книги, которое содержит больше 41 символа')
        collector_book.set_book_genre('Очень длинное название книги, которое содержит больше 41 символа', 'Ужасы')
        assert not collector_book.get_book_genre('Очень длинное название книги, которое содержит больше 41 символа')
    ...
    def test_set_book_genre_for_new_book(self, collector_book):
        collector_book.add_new_book('Оно')
        collector_book.set_book_genre('Оно', 'Ужасы')
